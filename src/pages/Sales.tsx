...
const data: Sale[] = orders;

// function descendingComparator(a: Sale, b: Sale, orderBy: keyof Sale) {
...
function getComparator<Key extends keyof Sale>(
    order: Order,
    orderBy: Key
...
const headCells: readonly HeadCell[] = [
    ...
    { id: 'casher_id', numeric: true, disablePadding: false, label: 'Casher' },
    ...
    { id: 'order_date', numeric: true, disablePadding: false, label: 'Order Date' },
...
function EnhancedTableHead(props: EnhancedTableProps) {
    ...
    const createSortHandler = (property: keyof Sale) => (event: React.MouseEvent<unknown>) => {
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
    const { numSelected, salesData, onSearch } = props;
...
const Sales = () => {
    ...
    return (
        <Paper elevation={0} sx={{ width: '100%', overflow: 'hidden' }}>
            <EnhancedTableToolbar numSelected={selected.length} salesData={data} onSearch={handleSearch} />
                        ...
                        {visibleRows.map((row) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <TableCell>{row.casher_id}</TableCell>
