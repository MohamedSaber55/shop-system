...
function getComparator<Key extends keyof Expense>(
    order: Order,
    orderBy: Key
...
const headCells: readonly HeadCell[] = [
    ...
    { id: 'amount', numeric: true, disablePadding: false, label: 'Amount (EGP)' },
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
    const { numSelected, expensesData, onSearch } = props;
...
const Expenses = () => {
    ...
    return (
        <Paper elevation={0} sx={{ width: '100%', overflow: 'hidden' }}>
            <EnhancedTableToolbar numSelected={selected.length} expensesData={data} onSearch={handleSearch} />
