...
function descendingComparator(a: Category, b: Category, orderBy: keyof Category) {
...
const Categories = () => {
    ...
    return (
        <Paper elevation={0} sx={{ width: '100%', overflow: 'hidden' }}>
            <EnhancedTableToolbar numSelected={selected.length} categoriesData={data} onSearch={handleSearch} />
