...
function descendingComparator(a: Product, b: Product, orderBy: keyof Product) {
...
const headCells: readonly HeadCell[] = [
    ...
    { id: 'isStock', numeric: true, disablePadding: false, label: 'In Stock' },
    { id: 'category_id', numeric: false, disablePadding: false, label: 'Category' },
];
...
function EnhancedTableToolbar(props: EnhancedTableToolbarProps) {
    const { numSelected, productsData, onSearch } = props;
...
const Products = () => {
    ...
    return (
        <Paper elevation={0} sx={{ width: '100%', overflow: 'hidden' }}>
            <EnhancedTableToolbar numSelected={selected.length} productsData={data} onSearch={handleSearch} />
